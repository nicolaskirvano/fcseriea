---
title: "Sobre"
description: "Conheça a equipe editorial do Serie A Coins, a origem dos dados e os critérios aplicados às análises de EA FC."
---

O **Serie A Coins** é uma publicação editorial especializada em EA FC Ultimate Team. Nosso foco é claro: preços, mercado e investimentos da Serie A no EA FC Ultimate Team, atualizados todos os dias.

## Quem assina

As publicações são assinadas por **Serie A Coins**. O sistema organiza dados de mercado, produz tabelas e aplica regras editoriais reproduzíveis antes de liberar cada análise. Dúvidas, correções e sugestões podem ser enviadas para [contato@futquant.com](mailto:contato@futquant.com).
